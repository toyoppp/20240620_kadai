...
$("#btn").on("click", function () {
    ...
    const requestUrl = `https://itunes.apple.com/search?lang=ja_JP&entry=music&media=music&country=JP&limit=10&term=${targetArtistName}`;
    ...
    $.getJSON(requestUrl, function (data) {
        ...
        data.results.forEach(function (song, index) {
            ...
            img_arr.push(`<img src="${artworkUrl}" alt="Artwork">`); // 画像URLを配列に追加

        });

        console.log("Image URLs:", img_arr);
    });
});
...
//     console.log("Image URLs:", img_tag_arr);
// }
...
function turn(e) {
    ...
    if (div.innerHTML == '') {
        ...
        div.innerHTML = img_arr[div.number];
    } else {
